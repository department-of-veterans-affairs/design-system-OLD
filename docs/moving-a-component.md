...
6. Add some unit tests (those may also be able to be copied from vets-website if they exist). Be sure to follow the [accessibility guidelines](./Accessibility and 508/README.md) for automated a11y tests as well. 
