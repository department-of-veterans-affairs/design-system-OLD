...
Good examples of MDX: 
[http://dump.jamesknelson.com/mdxc-playground.html](http://dump.jamesknelson.com/mdxc-playground.html)

### Adding React Component documentation
Adding React Components documentation in Formation.

- **Take a look at the example MDX file. You can use this as a starter**

  `formation-react/src/components/AcceptTermsPrompt/AcceptTermsPrompt.mdx.`
